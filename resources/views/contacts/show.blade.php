                    ...
                    <section class="text-gray-600 body-font relative">
                        {{-- {{ $contact->id }}{{ $contact->name }} --}}
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                {{-- <a href="{{ route('contacts.edit', [ 'id' => $contact->id]) }}" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集する</a> --}}
