                    ...
                    <section class="text-gray-600 body-font relative">
                        <form method="post" action="{{ route('contacts.update', [ 'id' => $contact->id ]) }}">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                <div class="p-2 w-full">
                                    ...
                                    <label for="age" class="leading-7 text-sm text-gray-600">年齢</label>
                                        <select name="age">
                                            ...
                                            <option value="1" @if($contact->age === 1) selected @endif>〜１９歳</option>
                                            <option value="2" @if($contact->age === 2) selected @endif>２０歳〜２９歳</option>
                                            ...
                                            <option value="6" @if($contact->age === 6) selected @endif>６０歳〜</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="p-2 w-full">
                                ...
                                <div class="p-2 w-full">
                                    <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">変更を保存</button>
                                </div>
                                </div>
                            </div>
                            </div>
